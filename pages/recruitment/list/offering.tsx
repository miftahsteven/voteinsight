	...
	return (
		<PageWrapper>
												...
												<td>
													<Dropdown>
														...
														<DropdownMenu isAlignmentEnd>
															...
															<DropdownItem className={i.approval_process.filter((item: any) => item.approval_type === i.recruitment_status?.id).length >= 1 ? '' : 'd-none'}>																
																<Button
																	icon='NavigateNext'
																	tag='a'
			...
			<CanvasEdit
				...
				errorUrl='/recruitment/list/offering'
			/>			
			<Approval
